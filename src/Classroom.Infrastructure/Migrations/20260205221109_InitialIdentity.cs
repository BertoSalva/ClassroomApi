        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassroomGroups_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassroomGroups_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ClassroomGroupId = table.Column<int>(type: "integer", nullable: false),
                    LearnerUserId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_ClassroomGroups_ClassroomGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceFiles_ClassroomGroups_ClassroomGroupId",
                        column: x => x.ClassroomGroupId,
                        principalTable: "ClassroomGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassroomGroups_GradeId",
                table: "ClassroomGroups",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassroomGroups_SubjectId",
                table: "ClassroomGroups",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_ClassroomGroupId",
                table: "Enrollments",
                column: "ClassroomGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceFiles_ClassroomGroupId",
                table: "ResourceFiles",
                column: "ClassroomGroupId");
